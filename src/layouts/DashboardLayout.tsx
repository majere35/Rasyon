...
export type ActiveTab = 'pos' | 'recipes' | 'ingredients' | 'targets' | 'balance' | 'monthly_accounting' | 'market_analysis' | 'suppliers' | 'admin_dashboard' | 'admin_users' | 'admin_reports' | 'admin_settings';
